...
with st.sidebar:
    ...
    st.markdown('<div class="side-note">The model forecasts demand from the day of week and '
                'hour of day, so you choose those directly. Every date that falls on the same '
                'weekday shares the same typical pattern.</div>', unsafe_allow_html=True)
...
.side-note { font-size:.78rem; color:var(--muted); margin-top:14px; line-height:1.55;
  background:#F4EEE3; border:1px solid var(--line); border-radius:12px; padding:11px 13px; }
